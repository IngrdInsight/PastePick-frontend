...
export default function SettingsPage() {
  ...
  return (
    <div
      className={`pb-20 px-4 py-6 min-h-screen transition-colors duration-300 ${
    ...
    >
      ...
      <div className="space-y-6">
        {settingSections.map((section, sectionIndex) => (
          <div key={sectionIndex}>
            ...
            <div
              className={`rounded-lg border shadow-sm overflow-hidden transition-colors duration-300 ${
                isDark
      ...
      <div className="mt-8 text-center">
        <div
          className={`p-4 rounded-lg border mb-4 transition-colors duration-300 ${
            isDark
